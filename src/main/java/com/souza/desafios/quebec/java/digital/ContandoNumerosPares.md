...
Dado um inteiro positivo **num**, retorne o número de inteiros positivos **menor ou igual** a **num** cuja soma de
dígitos é **par**. A soma dos dígitos de um inteiro positivo é a soma de todos os seus dígitos.
